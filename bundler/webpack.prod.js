...
// Плагин очистки проекта от отладочной информации (комментариев, "дебажного мусора" и прочего):
...
module.exports = merge( // Слияние
    ...
    // Production-конфигурация:
    {
        ...
        plugins:
        [
            // Очистка проекта от отладочной информации (комментариев, "дебажного мусора" и прочего):
